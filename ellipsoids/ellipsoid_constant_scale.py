...
for i in range(number_of_spheres):
    ...
    ellipsoid.location = center_char[i]
    #(center_char[i][0], center_char[i][1], center_char[i][2])
      
#Update the scene
bpy.context.view_layer.update()
# Save the Blender file
bpy.ops.wm.save_as_mainfile(filepath='C:/Users/tutko/Desktop/Vysledne-plochy/ellipsoids/constant_scale/' + text_file + '.blend') 
