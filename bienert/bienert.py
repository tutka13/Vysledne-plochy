...
t_values_negative = [-i * step for i in range(n_spheres)]
t_values_positive = [i * step for i in range(n_spheres)]

# Set the range of t values for the curve
t_values = np.arange(-10, 10, step)
...
shift_array = np.arange(-200, 200, 40)
